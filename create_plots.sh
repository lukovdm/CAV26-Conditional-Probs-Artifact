...
if [ "$folder" == "res" ]; then
    ...
    echo "Fig. 2:"
    echo "  - Left: $base/plots/rq1/res/scatter_bounded_bisection_exact_vs_restart_exact.pdf"
    echo "  - Right: $base/plots/rq1/res/scatter_bounded_bisection_float_vs_restart_float.pdf"
    echo "Fig. 3:"
    echo "  - Left: $base/plots/rq1/res/scatter_quantitative_bisection-pt_exact_vs_restart_exact.pdf"
    echo "  - Right: $base/plots/rq1/res/scatter_quantitative_bisection-pt_float_vs_restart_float.pdf"
    echo "Fig. 4:"
    ...
    echo "RQ1: $base/plots/rq1"
    echo "RQ2: $base/plots/rq2"
    echo "RQ3: $base/plots/rq3"
fi